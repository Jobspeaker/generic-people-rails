GenericPeopleRails::Engine.routes.draw do
  ...
  match "generic_people_rails/resend_confirmation" => "credentials#resend_confirmation" , as: :resend_confirmation, via: :get 
end
...
Rails.application.routes.draw do
  ...
  match "resend_confirmation" => "generic_people_rails/credentials#resend_confirmation" , as: :resend_confirmation, via: :get   
end